...
class MultiHeadAttentionWithContext(nn.Module):
    ...
    def forward(self, query: torch.Tensor, key: torch.Tensor, value: torch.Tensor,
                ...
                market_context: Optional[torch.Tensor] = None) -> torch.Tensor:
...
class OrderFlowTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.regime_embedding = nn.Embedding(4, d_model)  # 4 regimes: normal, volatile, trending, mean-reverting
    ...
    def detect_market_regime(self, x: torch.Tensor) -> torch.Tensor:
        ...
        regime[(volatility < volatility.median()) & (trend.abs() < 0.01)] = 3  # Mean-reverting
